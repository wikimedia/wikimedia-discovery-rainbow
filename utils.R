...
date_range_switch <- function(date_range, daily = 2, weekly = 14, monthly = 60, quarterly = 90) {
  return(switch(date_range, daily = daily, weekly = weekly, monthly = monthly, quarterly = quarterly))
}
